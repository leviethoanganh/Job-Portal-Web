      ...
      <div className="pt-[30px] pb-[60px]">
        <div className="contain">
          ...
          <div className="border border-[#DEDEDE] rounded-[8px] p-[20px]">
            ...
            <div className="mt-[20px] flex flex-col gap-[10px]">
              <div className="flex gap-[5px] flex-wrap border-b pb-2">
                <div className="font-[400] text-[16px] text-[#A6A6A6]">Company Model:</div>
                <div className="font-[400] text-[16px] text-[#121212]">{companyDetail.companyModel}</div>
              </div>
              <div className="flex gap-[5px] flex-wrap border-b pb-2">
                <div className="font-[400] text-[16px] text-[#A6A6A6]">Company Size:</div>
                <div className="font-[400] text-[16px] text-[#121212]">{companyDetail.companyEmployees}</div>
              </div>
              <div className="flex gap-[5px] flex-wrap border-b pb-2">
                <div className="font-[400] text-[16px] text-[#A6A6A6]">Working Hours:</div>
                <div className="font-[400] text-[16px] text-[#121212]">{companyDetail.workingTime}</div>
              </div>
              <div className="flex gap-[5px] flex-wrap">
                <div className="font-[400] text-[16px] text-[#A6A6A6]">Overtime:</div>
          ...
          <div className="border border-[#DEDEDE] rounded-[8px] p-[20px] mt-[20px]">
            <h2 className="font-[700] text-[20px] mb-[10px]">Description</h2>
            <div
          ...
          <div className="mt-[30px]">
            ...
            {jobList && jobList.length > 0 ? (
              ...
              <div className="text-center py-10 text-gray-500 border border-[#DEDEDE] rounded-[8px]">
                No jobs available from this company at the moment.
              </div>
            )}
          </div>
