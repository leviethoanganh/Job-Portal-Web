...
exports.deleteCV = exports.detailCV = exports.listCV = exports.profilePatch = exports.loginPost = exports.registerPost = void 0;
...
const loginPost = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existAccount = yield account_user_model_1.default.findOne({ email: email });
        if (!existAccount) {
            return res.json({
                code: "error",
